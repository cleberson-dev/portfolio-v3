...
export const Project = ({
  ...
  return (
    <div className="flex flex-col items-center bg-white text-black py-6 px-10 rounded-md">
      ...
      />
      <p className="w-64 font-bold text-xl text-center my-2 lg:text-2xl lg:text-left lg:my-0 lg:mt-4">
        {name}
      </p>
      <p className="w-64 text-center text-sm lg:text-left lg:text-base">
        {description}
      </p>
